        ...
        <div class="container">
            <div class="row top judulano">
                <div class="col align-self-center">
                    ...
                    <a class="btn btn-primary mt-4 animate__animated animate__fadeInLeft" href="<?php echo e(url('/download')); ?>" role="button">Get started</a>
                </div>
                <div class="col d-flex justify-content-center  gambar ">
                    <img width="550" class="d-none d-sm-block animate__animated animate__fadeInRight" src="<?php echo e(URL::asset('gambar/mix.svg')); ?>" alt="">
                </div>
            </div>
        </div>
    </section>
