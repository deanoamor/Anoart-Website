<div class="container-fluid">
    <div class="row footm">
            ...
            <div class="row align-items-center foot">
                <div class="col d-flex justify-content-center">
                    <a class="navbar-brand" href="<?php echo e(url('/home')); ?>">
                        <img class="logo" src="<?php echo e(URL::asset('gambar/anoulogowhite.svg')); ?>" width="140">
                    </a>
                </div>
            </div>
        ...
        <div class="col-8 ">
            <div class="row align-items-center foot2">
                <div class="container">
                    <div class="row">
...
</div><?php /**PATH C:\xampp\htdocs\anoart\resources\views/template/footer.blade.php ENDPATH**/ ?>